...
| `inventory_current_v1.json` | `evidence/inventory_current.sql` | `INVENTORY_DETAILS` | ⛔ **Bloqueado desde el MCP** (no hay `INVENTORY_DETAILS_SV`), pero la query quedó **lista y con los nombres de columna confirmados** contra el esquema real. Correr con acceso directo. Archivo del 2026-08-06 |
